...
@section('content')
    <div class="container">
        <div class="row">
            <h1 class="my-2">Food Menu</h1>
            <hr>
        <div class="my-2">
            <a href="{{ route("menu.create") }}" class="btn btn-primary px-4">Add Food</a>
        </div>
        </div>
        <div class="row py-5">
            @if (Session::has('msg'))
        ...
        <table class="table table-striped table-bordered mt-4">
            ...
            <tr>
                ...
                <td><img src="/images/{{ $item->image }}" height="70px" width="80px"></td>
                <td >
                    <div class="d-flex">
                    <div class="p-2">
                        ...
                        <div class="modal-content">
                            ...
                            <form method="POST" action="{{ route('menu.update',$item->id) }}" enctype="multipart/form-data" >
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="old_price" class="form-control" value="{{ $item->price }}" placeholder="Old price">
                                </div>
                                <div class="mb-3">
